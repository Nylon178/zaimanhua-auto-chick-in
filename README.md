...
| 功能 | 说明 | 触发时间 (北京) |
|-----|------|----------------|
| 每日签到 | 自动完成签到任务 | 8:00, 12:00, 20:00 |
| 每日评论 | 在随机漫画下发表评论 | 9:30 |
| 每日阅读 | 自动阅读漫画（见下方说明） | 10:00 |
...
> **原因说明：**
> 经过详细测试验证，"累计观看十分钟"任务的阅读时长（ReadingDuration）仅由**移动端 APP 内置 SDK** 追踪上报。
> 网页端（包括桌面版和移动版网页）的阅读行为**不会**更新服务器的阅读时长计数器。
> 这是平台的技术限制，非脚本问题。如需完成此任务，请使用官方移动端 APP 阅读。
